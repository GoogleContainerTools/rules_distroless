...
This documentation provides an overview of the convenience `deb_index`
...
def deb_index(
    ...
    Here's an example to create a Debian repo with `deb_index`:
    ...
    `deb_index` will parse the manifest and will fetch and install the packages
